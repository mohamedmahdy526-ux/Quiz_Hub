...
bot.hears("📝 إنشاء ونشر كويز", async (ctx) => {
  ...
  return ctx.reply(
    ...
    `------------------------------------\n` +
    `💡 **ملاحظة هامة للناشر:** يمكنك استخراج وتنسيق أسئلتك تلقائياً من ملفات Word أو PDF أو الصور باستخدام مساعد جيمناي المخصص:\n` +
    `👉 [اضغط هنا لفتح مساعد كويزات المنيا على جيمناي](https://gemini.google.com/gem/1y41F9aBEtDzwfLp08gFRPC5fyZxkPKQn?usp=sharing) 🩺✨\n\n` +
    `✍️ **الخطوة 1:** يرجى إرسال ملف الأسئلة بصيغة \`.txt\` الآن.\n\n` +
    `وسيقوم البوت باستخراج الأسئلة وتجهيزها لتتمكن من نشرها مباشرة في الجروبات والمجموعات باستخدام أمر /publish !`,
    {
      parse_mode: 'Markdown',
